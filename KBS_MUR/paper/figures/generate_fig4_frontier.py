...
def main() -> None:
    ...
    fig, axes = create_subplots(1, 2, figsize=(5.4, 2.45), sharey=True)
    ...
    for ax, harm in zip(axes, ("0.25", "0.5")):
        ...
        curve_specs = [
            ("mur_interval", "Calibrated stopping", PALETTE["green_3"], "o"),
            ("mur_free_threshold", "Free-threshold control", PALETTE["teal"], "D"),
        ]
