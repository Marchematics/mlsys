...
| R061 | M4 | Electricity router smoke | Static/MUR-light/full | train/cal/test smoke | MSE, runtime | MUST | INCONCLUSIVE | split audit passes; larger and same-client diagnostics still do not pass Gate D |
