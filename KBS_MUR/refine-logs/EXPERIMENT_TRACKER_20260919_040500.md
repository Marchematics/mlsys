...
| R020 | M2 | Gate N low redundancy | four-line novelty set | synthetic r=0 | recovery, duplicates | MUST | TODO | 3 seeds; not started |
...
| R023 | M2 | K scaling | Static/Coverage/MUR | synthetic K=4..32 | recovery, latency | MUST | TODO | default r=.5; formal confirmatory run pending |
