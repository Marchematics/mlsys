...
|---|---|---|---|---|---|---|---|---|
| R001 | M0 | unit contracts | MUR core | synthetic unit | tests | MUST | PASS | 10 tests green on 2026-09-19 |
| R002 | M0 | oracle headroom | Base/Pool/Oracle | synthetic smoke | loss, oracle gain | MUST | TODO | K=8, B=2 |
...
| R010 | M1 | Gate A seed 1 | Relevance/Static/Hashimoto | synthetic default | recovery, NTR | MUST | TODO | harmful sweep |
| R011 | M1 | Gate A seed 2 | Relevance/Static/Hashimoto | synthetic default | recovery, NTR | MUST | TODO | harmful sweep |
| R012 | M1 | Gate A seed 3 | Relevance/Static/Hashimoto | synthetic default | recovery, NTR | MUST | TODO | harmful sweep |
| R020 | M2 | Gate N low redundancy | four-line novelty set | synthetic r=0 | recovery, duplicates | MUST | TODO | 3 seeds |
| R021 | M2 | Gate N medium redundancy | four-line novelty set | synthetic r=.5 | recovery, duplicates | MUST | TODO | 3 seeds |
| R022 | M2 | Gate N high redundancy | four-line novelty set | synthetic r=.75 | recovery, duplicates | MUST | TODO | 3 seeds |
| R023 | M2 | K scaling | Static/Coverage/MUR | synthetic K=4..32 | recovery, latency | MUST | TODO | default r=.5 |
| R024 | M2 | MUR-full diagnostic | light/full | synthetic high-r | loss, calls, latency | NICE | TODO | no deployability claim |
...
| R060 | M4 | Electricity builder smoke | frozen ridge expert | four partitions | overlap, headroom | MUST | TODO | K=8, B<=2 |
| R061 | M4 | Electricity router smoke | Static/MUR-light | small train/cal/test | MSE, runtime | MUST | TODO | 1 seed |
