...
response-aware routers and shows how that familiar expression sits inside a
broader loss geometry.
...
The corollary gives the paper's main practical prediction. As model adaptation
removes systematic residual structure, the coefficient the router must estimate
shrinks while the curvature term remains. Oracle opportunity can stay large at
the same time. The selector then faces a qualitatively different problem: more
value exists in principle than can be recovered from the observations available
