...
def main() -> None:
    ...
    fig, axes = create_subplots(1, 4, figsize=(12.4, 2.9))
    ...
    axes[1].annotate("noise exceeds margin\nat every $K$", xy=(16, float(vect("median_ratio_max_error_margin_positive")[0][2])),
                     xytext=(6, 1.15), fontsize=7, color="#4D4D4D")
